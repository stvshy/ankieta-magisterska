...
const ProfilingStep = ({
  ...
  <div className="space-y-8 animate-fadeIn">
    <div>
      <h2 className="-mt-[14px] md:mt-0 text-[18.6px] md:text-[21.5px] font-bold text-[#316de5] mb-[15px] md:mb-6 ">
    ...
    <div className="pt-5 md:pt-7 border-t border-gray-300 mt-8 md:mt-11">
      <h2 className="text-[18.6px] md:text-[21.6px] font-bold text-[#316de5] mb-2.5 md:mb-3">
